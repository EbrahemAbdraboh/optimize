...
export const ServicesContent = props => {
  return(
    ...
    {/* Engineering Level 1     */}
      <p id='eng' className='services-title'>Engineering Services</p>
    ...
    {/* Upstream Level 1.2.1       */}
      ...
      {/* Gas gathering Level 1.2.3       */}
          <p id='eng-123' className='services-sub-sub-title'>Gas gathering stations &amp; Gas processing plants</p>
        ...
        {/* Refinery Level 1.2.4       */}
            <p id='eng-124' className='services-sub-sub-title'>Refinery Units: Modeling &amp; optimization for the following unit operation.</p>
        ...
        {/* Advanced Level 1.2.5       */}
            <p id='eng-125' className='services-sub-sub-title'>Advanced Analysis Group within OPTIMIZE Engineering can support and provide the following domains.</p>
        ...
        {/* Mechanical Level 1.3       */}
            <p id='eng-13' className='services-sub-title'>Mechanical Engineering</p>
        ...
        {/* Piping Level 1.4       */}
            <p id='eng-14' className='services-sub-title'>Piping Engineering</p>
        ...
        {/* Civil Level 1.5       */}
            <p id='eng-15' className='services-sub-title'>Civil and Structural Engineering</p>
        ...
        {/* FEED Level 1.8       */}
            <p id='eng-18' className='services-sub-title'>FEED and Detailed Engineering</p>
        ...
        {/* Safety Level 2       */}
            <p id='process' className='services-title'>Process Safety Management &amp; HSE</p>
        ...
        {/* Project Level 3    */}
          <p id='project' className='services-title'>Project Management</p>
